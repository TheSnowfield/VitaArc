...
#ifndef __BRIDGES_JNI_AOSP_JNI_H
#define __BRIDGES_JNI_AOSP_JNI_H
 ...
 */
JNIIMPORT jint (*JNI_OnLoad)(JavaVM* vm, void* reserved);
JNIIMPORT void (*JNI_OnUnload)(JavaVM* vm, void* reserved);
...
#endif  /* __BRIDGES_JNI_AOSP_JNI_H */
